...
(function (global, factory) {
  ...
  var ordinaryToPrimitive$1 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && typeof (fn = input.toString) === 'function' && !isObject$4(val = fn.call(input))) {
      return val;
    }
	  if (typeof (fn = input.valueOf) === 'function' && !isObject$4(val = fn.call(input))) {
      return val;
    }
	  if (pref !== 'string' && typeof (fn = input.toString) === 'function' && !isObject$4(val = fn.call(input))) {
      return val;
  ...
  objectGetOwnPropertyDescriptor.f = DESCRIPTORS$3 ? $getOwnPropertyDescriptor : function getOwnPropertyDescriptor(O, P) {
	  ...
	  if (has$4(O, P)) {
      return createPropertyDescriptor$1(!propertyIsEnumerableModule$1.f.call(O, P), O[P]);
    }
  };
